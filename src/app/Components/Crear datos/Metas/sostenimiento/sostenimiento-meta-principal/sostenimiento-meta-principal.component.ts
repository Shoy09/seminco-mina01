...
@Component({
  selector: 'app-sostenimiento-meta-principal',
  imports: [CommonModule, FormsModule],
  templateUrl: './sostenimiento-meta-principal.component.html',
  styleUrl: './sostenimiento-meta-principal.component.css'
})
export class SostenimientoMetaPrincipalComponent implements OnInit {
  meses: string[] = [
